...
neun.plot <- FeaturePlot(rmip, c('RBFOX3'), min.cutoff='q5')+ NoLegend()+ggtitle("NeuN") +xlab('UMAP 1') + ylab('UMAP 2')+ NoLegend() +ftheme + theme(axis.title.x =element_text(size=ss-4), axis.title.y =element_text(size=ss-4), plot.title=element_text(size=ss-2, hjust=0.5,  face="bold"))
gli2.plot <- FeaturePlot(rmip, c('GLI2'), min.cutoff='q5') + NoLegend() +ggtitle("GLI2") +xlab('UMAP 1') + ylab('UMAP 2')+ NoLegend()+ ftheme + theme(axis.title.x =element_text(size=ss-4), axis.title.y =element_text(size=ss-4), plot.title=element_text(size=ss-2, hjust=0.5,  face="bold"))
top2a.plot <- FeaturePlot(rmip, c('TOP2A'), min.cutoff='q5')+ NoLegend() +ggtitle("TOP2A") +xlab('UMAP 1') + ylab('UMAP 2')+ NoLegend() + ftheme + theme(axis.title.x =element_text(size=ss-4), axis.title.y =element_text(size=ss-4), plot.title=element_text(size=ss-2, hjust=0.5,  face="bold"))
